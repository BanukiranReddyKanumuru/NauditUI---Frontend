...
export const PATH_DASHBOARD = {
  ...
  user: {
    ...
    // employee list
    employeeedit: (id: string | undefined) => path(ROOTS_DASHBOARD, `/user/${id}/employeeedit`),
  ...
  hr: {
    ...
    statusview: (name: string) => path(ROOTS_DASHBOARD, `/hr/${name}/statusview`),
    // statusname: path(ROOTS_DASHBOARD, '/hr/statusname'),
